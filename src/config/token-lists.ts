...
const SET_LIST = 'https://raw.githubusercontent.com/1ombfinance/tokenlist/main/default-token-list.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [SET_LIST]
